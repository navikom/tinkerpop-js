...
import B_LP_O_P_S_SE_SL_Traverser from './B_LP_O_P_S_SE_SL_Traverser';
 ...
 */
export default class B_LP_O_P_S_SE_SL_TraverserGenerator extends TraverserGenerator {
	constructor() {
		super();
		if (!INSTANCE) {
			INSTANCE = this;
	...
	static instance(){
		return new B_LP_O_P_S_SE_SL_TraverserGenerator();
	}
}
